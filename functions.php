...
add_action('wp_enqueue_scripts', 'tuwyn_scripts', 100);
function tuwyn_scripts(){
  wp_register_script(
    'bootstrap-script', 
  ...
  wp_register_script(
    'tuwyn-scripts', 
    get_template_directory_uri() . '/js/tuwyn-scripts.js', 
    array('jquery'), 
    '', 
    true
  );
...
function tuwyn_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
  wp_register_style('google-fonts', '//fonts.googleapis.com/css?family=Open+Sans:400,400i,700');
  wp_register_style('tuwyn', get_template_directory_uri() . '/style.css');
  
  wp_enqueue_style('bootstrap-css');
  wp_enqueue_style('google-fonts');
  wp_enqueue_style('tuwyn');
}
